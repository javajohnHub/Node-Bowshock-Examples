...
export class MyBasePanelMenuItem {
        ...
        <ul class="ui-submenu-list" [@submenu]="expanded ? 'visible' : 'hidden'">
            <ng-template ngFor let-child [ngForOf]="item.items">
                ...
                <li *ngIf="!child.separator" class="ui-menuitem ui-corner-all" [ngClass]="child.styleClass" [class.ui-helper-hidden]="child.visible === false" [ngStyle]="child.style">
                    ...
                    <my-p-panelMenuSub [item]="child" [expanded]="child.expanded" *ngIf="child.items"></my-p-panelMenuSub>
                </li>
            </ng-template>
        </ul>
    `,
...
export class MyPanelMenuSub extends MyBasePanelMenuItem {
            ...
            <ng-container *ngFor="let item of model;let f=first;let l=last;">
                <div class="ui-panelmenu-panel" [ngClass]="{'ui-helper-hidden': item.visible === false}">
                    ...
                    'ui-state-active':item.expanded,'ui-state-disabled':item.disabled}" [class]="item.styleClass" [ngStyle]="item.style">
                        ...
                        <span class="ui-menuitem-text sub">{{item.title}}</span>
                        </a>
                    ...
                    <div *ngIf="item.items" class="ui-panelmenu-content-wrapper" [@rootItem]="item.expanded ? 'visible' : 'hidden'"  (@rootItem.done)="onToggleDone()"
                        ...
                        <div class="ui-panelmenu-content ui-widget-content">
                            <my-p-panelMenuSub [item]="item" [expanded]="true" class="ui-panelmenu-root-submenu"></my-p-panelMenuSub>
                        </div>
                    </div>
                </div>
            </ng-container>
...
export class MyPanelMenu extends MyBasePanelMenuItem {
...
@NgModule({
    ...
    exports: [MyPanelMenu,RouterModule],
    declarations: [MyPanelMenu,MyPanelMenuSub]
})
export class MyPanelMenuModule { }